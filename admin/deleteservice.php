                            ...
                            <div class="addnewbox">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div><button type="button" id="deletemservice" name="deletemservice">Delete Master Service</button></div>
                                    </li>
                                    <li>
                                        <label for="sub_service">Sub Service<span style="color:red">*</span></label>
                                        <input type="text" id="sub_service" name="sub_service">
                                        <div><button type="button" id="deletesservice" name="deletesservice">Delete Sub Service</button></div>
                                    </li>
                                    <li>
                                        ...
                                        <div><button type="button" id="deletessservice" name="deletessservice">Delete Sub Sub Service</button></div>
                                    </li>
                            </div>
                            <div><button type="button" id="deleteservice" name="submit"><a style="color: white" href="addeditservices.php">Done</a></button></div>
                        </div>
