...
var display_contract = base_api_url + "contract/display.php";
var register = base_api_url + "contract/register.php";
var display_company = base_api_url + "contract/company.php";
var delete_company = base_api_url + "contract/delete_company.php";
var addcompany = base_api_url + "contract/addcompany.php";
var viewcompany = base_api_url + "contract/viewcompany.php";
var fetch = base_api_url + "contract/fetch.php";
var allcompany = base_api_url + "contract/allcompany.php";
var generate_contract = base_api_url + "contract/generatecontract.php";
...
var delete_uploaded_contract = base_api_url + "contract/delete_uploaded.php";
